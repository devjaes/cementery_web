                    ...
                    <div className="flex items-start justify-between">
                        ...
                        {selectedCemetery && (
                            <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                ...
                                <span className="font-medium">{cemeteries.length} cementerio{cemeteries.length !== 1 ? 's' : ''}</span>
                            </div>
                        )}
                    </div>
                </CardHeader>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                        ...
                        >
                            <SelectTrigger className="w-full sm:flex-1">
                                <SelectValue placeholder="Selecciona un cementerio" />
                            </SelectTrigger>
                            <SelectContent>
                                {cemeteries.map((cemetery) => (
                                    <SelectItem key={cemetery.idCementerio} value={cemetery.idCementerio}>
                                        {cemetery.nombre}
                                    </SelectItem>
                                ))}
                            </SelectContent>
                                ...
                                <div className="flex items-center gap-3 flex-wrap">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Badge
                                                variant={selectedCemetery.estado === 'Activo' ? 'default' : 'secondary'}
                                                className={
