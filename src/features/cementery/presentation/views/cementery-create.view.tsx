...
const enableCreateCementery =
  process.env.NEXT_PUBLIC_ENABLE_CREATE_CEMENTERY === "true";

export default function CementeryCreateView() {
  if (enableCreateCementery) {
    return (
          ...
          <Card className="p-2 md:p-8">
            <CardHeader>
              ...
              <p className="text-muted-foreground text-sm mt-2">
                Completa los datos para registrar un nuevo cementerio.
              </p>
            </CardHeader>
            <CardContent>
              <CementeryForm />
