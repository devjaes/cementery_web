      ...
      <div className="overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>
                <span className="flex items-center gap-1">Nombre</span>
              </TableHead>
              <TableHead>
              ...
              <TableHead>
                <span className="flex items-center gap-1">Responsable</span>
              </TableHead>
              <TableHead>
          ...
          <TableBody>
            ...
            {cementeries?.map((cementery) => (
              <TableRow key={cementery.idCementerio}>
                ...
                <TableCell>
                  <StatusChip estado={cementery.estado} />
                </TableCell>
                <TableCell>
                  <div className="flex gap-2">
                    ...
                    <Button
                      variant={
                        selectedId === cementery.idCementerio
                          ? "secondary"
                          : "ghost"
                      }
                      onClick={() =>
                        onViewBlocksClick?.(cementery.idCementerio)
                      }
                      className="text-xs"
                    >
                      {selectedId === cementery.idCementerio
