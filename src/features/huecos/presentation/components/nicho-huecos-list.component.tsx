  ...
  return (
    <div className="rounded-lg border bg-white p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        {/* COMMENTED OUT: Crear Hueco button */}
        {/* <Button
          ...
          <TableBody>
            ...
            {huecos?.map((hueco) => (
              <TableRow key={hueco.idDetalleHueco}>
                ...
                {/* COMMENTED OUT: Archivo PDF cell */}
                {/* <TableCell>
                ...
                {/* COMMENTED OUT: Observaciones cell */}
